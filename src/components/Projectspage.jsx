        ...
        <div className="project-site">
            ...
            <div className="My-projects">
                <motion.div {...fadeInUp} className="project weather-app">
                    ...
                    <a href="https://weather-app-iota-blush-65.vercel.app/" target="_blank"  rel="noopener noreferrer"><button className="site-btn">visit site</button></a>
                </motion.div>
                <motion.div {...fadeInUp} className="project calculator ">
                    ...
                    <a href="https://lalithyaliki.github.io/Calculator/" target="_blank"  rel="noopener noreferrer"><button className="site-btn">visit site</button></a>
                </motion.div>
                <motion.div {...fadeInUp} className="project portfolio">
                    ...
                    <a href="https://lalithyaliki.github.io/new-portfolio/" target='_blank' rel="noopener noreferrer"><button className="site-btn">visit site</button></a>
                </motion.div>
                <motion.div {...fadeInUp} className="project todo">
                    ...
                    <a href="#"><button className="site-btn">visit site</button></a>
                </motion.div>
            </div>
        </div >
    )
